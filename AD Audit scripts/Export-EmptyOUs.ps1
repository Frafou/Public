...
.EXAMPLE
  Reporting and deleting all empty OUs found within the MGT OU. Store the report in C:\Scripts\AD\Audit\Report.
  .\Find-ADEmptyOU.ps1 -SeachScope "OU=MGT,DC=testlab,DC=com" -ReportFilePath 'C:\Reports\DeletedOUs.csv' -DeleteObjects

.LINK
  https://www.adaxes.com/blog/cleanup-active-directory-with-powershell.html
  https://github.com/9to5IT/PS-ManageInactiveAD
  #>
...
$ReportFilePath = "$ScriptPath" + '\Report\' + "$CSVName"
