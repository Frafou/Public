...
"----------------------------------------" | out-file .\Report.csv -append
    "DC: $domaincontroller" | out-file .\Report.csv -append
## Define Objects ##
...
## Format Output ##
$report | Select-Object ReplicationPartners,LastReplication,FirstFailure,FailureCount,FailureType | out-file .\Report.csv -append #| Out-GridView
}