...
Function Get-OuPermissions {
	...
	.DESCRIPTION
	Exports a CSV of OU Permissions for AD audit procedures. Does not include permissions for standard AD privileged groups or special identities such as "Self" or "CREATOR OWNER".
...
Function Get-DCsInDomain {
	...
	.DESCRIPTION
	Exports a list of Domain Controllers".
...
Function Get-DomainUsersAll {
	...
	Report	Fields:'SamAccountName', 'DistinguishedName', 'ObjectSID', 'Name', 'Description', 'pwdlastset', 'useraccountcontrol', 'whencreated', 'lastlogontimestamp','CannotChangePassword', 'LockedOut', 'Enabled', 'PasswordNeverExpires', 'PasswordNotRequired', 'AccountExpirationDate', 'LastLogonDate', 'whenchanged'
...
Function Get-LocalWMIUsersAll {
	...
	.DESCRIPTION
	Export all Local Users Accounts to file
	Report	Fields: 'SID', 'Name', 'FullName', 'Description', 'Disabled', 'useraccountcontrol', 'whencreated', 'Lockout', 'PasswordExpires', 'PasswordRequired', 'PasswordChangeable', 'lastlogontimestamp'
...
ProductType
Value   Meaning
0 			Product type is unknown
1				System is a workstation
2				System is a domain controller
3				System is a server
#>
