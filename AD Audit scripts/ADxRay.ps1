                ...
                Try
                    {
                        ...
                        Add-Content $report "                       <td align=center>High</td>"
                        Add-Content $report "                       <td align=center>Validates if the registry key <strong>'HKEY_Local_Machine\System\CurrentControlSet\Services\Netlogon\Parameters\SysvolReady=1'</strong> exist. This registry has to exist with value '1' for the DC큦 SYSVOL to be advertised.</td>"
                        Add-Content $report "                   </tr>"
                        Add-Content $report "                   <tr>"
                        ...
                        Add-Content $report "                       <td align=center>Medium</td>"
                        Add-Content $report "                       <td align=center>Validates if permissions are correctly set in this Domain Controller for all naming contexts. Those permissions directly affect replication큦 health.</td>"
                        Add-Content $report "                   </tr>"
                        Add-Content $report "                   <tr>"
...
Add-Content $report "               <p>This section will give a detailed view of the Domain Controller's Security. This inventory is based on Microsoft큦 best practices and recommendations.</p>"
Add-Content $report "           </section>"
...
Add-Content $report  "<p class='note'><font color=$TableFontOnError>Critical Security Events were found in this environment! Investigate further following Microsoft큦 <a href='https://docs.microsoft.com/en-us/windows-server/identity/ad-ds/plan/appendix-l--events-to-monitor' target='_blank' rel='external'>Events to Monitor in Active Directory</a>. </font></p>"
...
Add-Content $report "           <CENTER>"
Add-Content $report "               <p class='note'>This analysis is based on the Resultant Set of Policies applied on those Domain Controllers versus Microsoft큦 baseline security standards. Microsoft recommends the use of security baseline GPOs (<a href='https://techcommunity.microsoft.com/t5/microsoft-security-baselines/security-baseline-for-windows-10-version-21h2/ba-p/3042703' target='_blank' rel='external'>Security baseline for Windows 10, version 21H2</a>) in the environment, specially on Domain Controllers. Keep your environment protected with the lastest security baseline!</p>"
Add-Content $report "           </CENTER>"
